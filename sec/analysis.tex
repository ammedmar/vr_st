...
\subsection{Metric $\bS^n$ and $\rp^n$}

\subsubsection{} For any integer $n \geq 1$ and real number $r > 0$, let $\bS^n(r)$ be the $n$-sphere of radius $r$, equipped with the geodesic distance.
