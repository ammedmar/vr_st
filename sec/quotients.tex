...
\end{align*}
If the action is proper and by isometries as well as \(t^*\)-diameter, then for any \(s < t\), this map is a simplicial isomorphism\ling{verify. should it be a homomorphism. And use the footnote to mention the original proof is for the inverse direction.}. 
