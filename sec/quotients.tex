...
\begin{proof}
	...
	For any $i \leq j-1$, applying the degree $n_i$ reduced homology functor to diagram \eqref{eq:fundamental_bars_diagram} and using the fact that the $G$-action on the system is $\VR$-compatible (cf. \cref{ss:system VR compatible}), we obtain a commutative diagram of vector spaces:
