...
Let $\cX$ be a space.
The \defn{Hurewicz homomorphism} $h \colon \pi_i(\cX) \to \rH_i(\cX)$ is defined by choosing a generator $u$ of $\rH_i(S^i)$ and sending the homotopy class $[f]$ of a based map $f \colon \bS^i \to \cX$ to $f_*(u)$.
...
The Steenrod algebra $\cA_2$ is generated by the \defn{Steenrod squares} $\set{\Sq^i}_{i \in \N}$, where $\Sq^i \colon \rH^n(\cX; \Z/2) \to \rH^{n+i}(\cX; \Z/2)$ for any $n\geq 0$.
...
\]
and the \defn{Steenrod reduced powers} \(\set{\rP^i}_{i \in \N}\), where $\rP^i \colon \rH^n(\cX; \Z/p) \to \rH^{n+2i(p-1)}(\cX; \Z/p)$, for any $n\geq 0$.
