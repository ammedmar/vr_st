...
\]
defined by the canonical inclusions \(\bC^n \subset \bC^{n+1}\), with the \(\rC_q\) action, for some \(q \in \N\), defined by the diagonal action of group of \(q^\th\) roots of unity.
...
\]
where the binomial coefficient is taken mod~\(q\).
