...
% by the following properties holding for all cohomology classes \(\alpha, \beta \in \rH^*(\cX; \Fp)\) in any space \(\cX\):
...
% The action of the Steenrod algebra $\cA_p$ on $\rH^*(\rL^n_p, \Ftwo)$, for $n$ possibly equal to $\infty$, is determined by
% \[
