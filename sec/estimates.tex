...
%Since $\zeta_{n}$ is decreasing as a function of $n$, $r\leq \zeta_n$ implies $r\leq \zeta_i$ for all $i=1,\dots, n$.  
%Thus, for any $r\leq \zeta_n$, $\VR_r(\VS^{\ell_1,\dots,\ell_n})$ is homotopy equivalent to $\VS^{\ell_1,\dots,\ell_n}$. 
