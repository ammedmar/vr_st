...
\medskip\example
By \cref{ss:filling_radius}, the first critical value $\VR(\rp^n)$ is $\tfrac{2\pi}{3}$.\anibal{The reference doesn't seem to prove the claim.}
...
\begin{proof}
	...
	Thus, the claim holds.\anibal{Please write as a proof}
\end{proof}
...
\ling{To Anibal: please check that $\tilde{f}^n_G$ is well-defined for lens spaces and if it is a homotopy equivalence. }
