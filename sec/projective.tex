...
\begin{enumerate}
	\item \(\Rad_{htpy}(\rp^n) = \frac{2\pi}{3}\).
...
\begin{proof}
	...
	On the other hand, $\firstdeath{m}{\rp^n}\geq \tfrac{1}{2}\Rad_{htpy}(\rp^n) = \tfrac{\pi}{3}$.

	(3) We only need a proof for the case $k \leq \frac{n-1}{2}$ and $\binom{m-k}{k}$ odd, since \(\Sq^k = 0\) otherwise.
	Because $\Rad_{htpy}(\rp^n)=\frac{2\pi}{3}$, $\VR_r(\rp^n)$ retains the homotopy type of $\rp^n$ for $r \in (0,\tfrac{2\pi}{3})$.
	...
	On the other hand, $\firstdeath{\Sq^k}{\rp^n} \geq \tfrac{1}{2}\Rad_{htpy}(\rp^n) = \tfrac{\pi}{3}$.
\end{proof}
