...
\begin{proof}
    ...
    Consider the \(\rC_2\)-action on the real equatorial system \(\bS^{1} \to \bS^{2} \to \dotsb \to \bS^{n}\) of unit spheres.
...
\begin{proof}
    ...
    \ling{We did not define VR compatibility for non-unit spheres, so some of the proof needs to be written for unit spheres first and then be applied to the actual $L_p^n$.}
    ...
    \]
    Consequently, for any $m \leq 2n+1$, we obtain
    \[
