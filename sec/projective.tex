...
% \textcolor{red}{The first item below is stated in \cite[Thm.~4.5]{adams2022metric}, while the other two items follows from this result, previous sections, and \cite{katz1983filling}.
% }
