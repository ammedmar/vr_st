...
\begin{proof}
    ...
    \ling{We did not define VR compatibility for non-unit spheres, so some of the proof needs to be written for unit spheres first and then be applied to the actual $L_p^n$.}\anibal{@Ling: This is pending}
