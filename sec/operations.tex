...
Any cohomology operation $\theta \in \cO(\kk,n; \kk,m)$ defines a morphism of persistence modules $\theta \colon \rH^n(X; \k) \to \rH^m(X; \k)$ for any $\R$-diagram of spaces $X$. \ling{I think this $\theta$ depends on $X$ and we want to reflect that in the notation. To be consistent with other notation, we can do $\theta(X;\k)$ }
