...
\medskip\proposition
For any $m \in \N$ and linear cohomology operation $\theta \in \cO(\ell, m)$:
\[
...
We apply \cref{subsub:critical values of Sn} and the barcode estimates from \cref{subsub:barcode_general} to \(\bS^n\).
