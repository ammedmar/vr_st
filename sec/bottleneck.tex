...
\begin{itemize}
    \item $\crit(\cX) \geq \tfrac{\zeta_n}{2} $;
    \item $2\firstdeath{m}{\cX} < \tfrac{\zeta_n}{2}+\zeta_m$ for any $m \in N$.
\end{itemize}
As before, $\zeta_n = \arccos{(-\tfrac{1}{n+1})}$ for any $n\geq 1$.
...
\begin{proof}
    ...
    \begin{align*}
        \cost(P)
        = & \max\Big\{|\zeta_m - \beta_m|,\, \frac{\pi - \zeta_n}{2},\, \frac{\pi - 2\crit(\cX)}{2}\Big\} \\
        = & \max\Big\{|\zeta_m - \beta_m|,\, \frac{\pi - \zeta_n}{2}\Big\} \quad \text{(since \( \zeta_n \leq 2\crit(\cX) \))}.
    \end{align*}
...
\begin{proof}
    ...
    Because \(\zeta_n \leq 2\crit(\cX) \leq \beta_m < \tfrac{\zeta_n}{2} + \zeta_m\), $\beta_m$ satisfies the condition in Part (2) of the above lemma.
    ...
    \]
    To obtain the rightmost inequality, note that \(\zeta_n \leq 2\crit(\cX) \leq \gamma_\theta\).
\end{proof}
