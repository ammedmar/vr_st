...
This demonstrates the enhanced discriminatory power of these persistent invariants in Riemannian geometry.
...
Below is a list of required properties for such an \(n\)-manifold.
...
Both, Desideratum~(1) and (2) remain unproven, but for (2) it suffices to check that
\[
