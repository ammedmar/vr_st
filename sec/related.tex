...
\ling{After the posting of the present work, \cite{memoli2025persistence}, drawing on the example developed here, investigated the problem of estimating the Gromov--Hausdorff distance between $\rp^n$ and $\bS^n$ using persistent invariants derived from cup-length, the Lyusternik--Schnirelmann category, topological complexity, and zero-divisor cup-length. 
In particular, they obtained the same lower bound of $\frac{\pi}{3}$ as established here.}