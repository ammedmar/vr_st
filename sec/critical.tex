...
The \(m\)-homological radius may depend on the coefficient field.
Throughout, we follow the convention in \cref{ss:filling_radii_def}, and omit \(\field\) from the notation whenever it is clear from context.
