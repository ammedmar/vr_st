...
\]
For non-orientable manifolds (eg, \(\mathbb{RP}^n\)), we take \(\field = \Ftwo\) so that the top-dimensional fundamental class is nontrivial.
...
By \cite[Theorem~3.5]{hausmann1995vietoris} and \cite[Theorem~4.1]{lim2024vietoris}, we know that there exists \(r_\cM > 0\) such that for all \(r \in (0, r_\cM)\) the inclusion \(\cM \to \rU_{r}(\cM)\) is a homotopy equivalence.
...
In \cite[Definition~9.44]{lim2024vietoris}, the authors define the generalized filling radius of a homology class \(\omega\) in \(X\) as the smallest \(r > 0\) for which \(\omega\) becomes trivial in \(\rU_r(\cX)\), capturing the scale at which \(\omega\) vanishes under the inclusion of \(X\) into its \(r\)-neighborhood.
...
Throughtout, we follow the convention in \cref{ss:filling_radii_def}, and omit \(\field\) from the notation whenever it is clear from context.
...
\proposition \cite[Theorem~4.1]{lim2024vietoris} The spaces $\VR_{2r}(\cX)$ and $\rU_r(\cX)$ are naturally homotopy equivalent for every \(r > 0\).
