...
\subsubsection{}
\ling{label and reference (may write it as a lemma) or remove; make correct assumptions on $\cX$.}
...
By the definition of the filling radius, it follows that the first critical value of the $n^\th$ homology of $\VR(\cX)$ is at most $2\fillradnofield{\cX}$.\anibal{I don't think this fragment is doing much. I would remove it if not referenced anywhere below.}
