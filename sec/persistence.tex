...
Moreover, \cite[Thm.~5.2]{lim2024vietoris} states that, when $\cX$ is compact, the barcode of the persistent homology of $\VR(\cX)$ always consists of intervals that are left-open and right-closed.
...
\ling{This paragraph explains the interval convention.}
