...
For an interval \(I \subset \R\), let \(C(I)\) denote the interval module, i.e.\ the persistence module that is \(\Bbbk\) on \(I\), zero elsewhere, and whose structure maps are the identity within \(I\) and zero otherwise.
