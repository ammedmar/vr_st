...
\proposition (\cite[page~1508]{bubenik2015metrics})
...
For an interval \(I \subset \R\), let \(C(I)\) denote the interval module, ie the persistence module that is \(\Bbbk\) on \(I\), zero elsewhere, and whose structure maps are the identity within \(I\) and zero otherwise.
...
\proposition (\cite[Theorem~5.14]{Chazal.2016a})
...
\proposition (\cite[Proposition~5.1]{chazal2014geometric})
...
\proposition (\cite[Theorem~5.2]{lim2024vietoris})
...
\proposition (\cite[Theorems~1.9 and~1.10]{blumberg2023interleaving})
