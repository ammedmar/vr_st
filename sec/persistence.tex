...
In this section we overview the key concepts in the theory of persistence and its applications to metric geometry.
...
\medskip\proposition(\cite[Thm.~5.14]{Chazal.2016a})
...
\medskip\proposition (\cite[Prop.~5.1]{chazal2014geometric})
...
%, as $(a, b)$ and $(a, b]$ are identified with the same point in $\R^2$ and we have
due to the following.

\medskip\proposition (\cite[Thm.~5.2]{lim2024vietoris})
...
\medskip\proposition (\cite[Thm.~1.9 \& 1.10]{blumberg2023interleaving})
