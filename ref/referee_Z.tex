...
%%%%%%%%%%%%%%%%%%%%%%
\title[Referee reply]{\underline{REPLY TO REFEREE Z} \\ Persistent cohomology operations \\ and Gromov--Hausdorff estimates}
...
\begin{document}
	...
	\begin{enumerate}
		...
		\ar The referee is correct that the commutative diagram can be modified as suggested. However, the base case of the induction in the proof of Lemma~4.5.4 relies on the fact that $\beta_1^1 = \delta_1$, which means the $n_1$-th homological radius of $\bS^{n_1}_G$ agrees with the filling radius of $\bS^{n_1}_G$.
		To establish the stronger bound $\beta_i^j \le \delta_{j-1}$, we would need to prove a new base case showing that the $n_1$-th homological radius of $\bS^{n_2}_G$ is bounded above by the filling radius of $\bS^{n_{1}}_G$.
