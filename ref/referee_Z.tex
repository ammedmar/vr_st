...
\begin{document}
	...
	\begin{enumerate}
		...
		\begin{quote}
			...
			Thus, the interleaving distance between these persistent homology groups is at most half the maximum bar length (with all bars unmatched), which is bounded by $\max\{\tfrac{\pi - \zeta_n}{2}, \tfrac{\pi}{6}\} \leq \tfrac{\pi - \zeta_n}{2}$ since $\zeta_n \leq \tfrac{2\pi}{3}$.
		\end{quote}
